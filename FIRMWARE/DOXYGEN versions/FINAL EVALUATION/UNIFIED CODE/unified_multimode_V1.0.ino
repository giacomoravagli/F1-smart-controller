/**
 *****************************************************************************************************
 * @file    unified_multimode.ino
 * @author  CL1 - Group 4
 * @version V1.0
 * @date    19-November-2019
 * @brief   This file contains the main application software of the CL1 board.
 ****************************************************************************************************
 *
...
#define LIS3DH_DEBUG Serial  /* Enable Serial debug on Serial UART to see registers wrote */


/* Includes ------------------------------------------------------------------*/
/* @brief Include the libraries, according to what is the functionality required */
#include "Wire.h"
#include <SPI.h>
...
#endif
#if defined(SLAVE_MODE) || defined(MASTER_MODE)
const static uint8_t PIN_RADIO_CE = 2;         // 2 = PE0 in the STM8AF board --> to be changed to 6 = PC3 in final board
...
#if defined(SLAVE_MODE)
/**
  * @brief  Initialization of the SLAVE node.
  * @param  None
  * @retval None
  */
void setup() 
...
#if defined(MASTER_MODE)
/**
  * @brief  Initialization of the MASTER node.
  * @param  None
  * @retval None
  */
void setup()
...
/**
  * @brief  Initialization of the WIRED SENSOR.
  * @param  None
  * @retval None
  */
void setup()
...
#if defined(MASTER_MODE) || defined(WIRED_SENSOR)
/**
  * @brief  Initialization and activation of the CAN peripheral.
  * @param  None
  * @retval None
  */
void setup_CAN()
...
#if defined(MASTER_MODE) || defined(WIRED_SENSOR)
/**
  * @brief  Transmission of a CAN message on CAN bus.
  * @param  None
  * @retval None
  */
...
/**
  * @brief  SOS message display by using the LEDs embedded in the STM8AF Development Board.
  * @param  None
  * @retval None
  */
